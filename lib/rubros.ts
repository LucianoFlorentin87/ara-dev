/**
 * Los nueve rubros y su contenido de marketing.
 *
 * Extraídos tal cual de `diseno/Rubros.dc.html` con un script, no
 * transcritos a mano: los bullets, las fichas y los precios de ejemplo son
 * exactamente los que escribió quien diseñó las páginas.
 */
