...
/**
 * El marco de dos columnas del diseño: formulario a la izquierda, panel
 * violeta a la derecha. Lo comparten el login y la recuperación de
 * contraseña para que se vean como la misma pantalla.
 */
